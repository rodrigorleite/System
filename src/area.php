...
$destino = "../backend/area/insert.php";
            ...
            <div class="col-3 mt-4">
                ...
                <form action="<?= $destino ?>" method="post">
                    ...
                    <div class="mb-3" style="display: none">
                        ...
                        <input readonly name="id" type="text" value="<?php echo isset($area) ? $area['id'] : "" ?>"
                            class="form-control" placeholder="">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Nome</label>
                        <input name="nome" type="text" value="<?php echo isset($area) ? $area['nome'] : "" ?>"
                            class="form-control" placeholder="Digite o nome">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Numero</label>
                        <input name="numero" type="text" value="<?php echo isset($area) ? $area['numero'] : "" ?>"
                            class="form-control" placeholder="Digite o numero">
                    </div>
                        ...
                        while ($coluna = mysqli_fetch_assoc($dados)) {
                            ...
                            <tr class="text-center">
                                ...
                                <td class="text-center">
                                    <a href="./area.php?id=<?= $coluna['id'] ?>"><i class="fa-solid fa-pencil me-4"
                                            style="color: #9c7aff;"></i></i></a>
                                    <a href="<?php echo "../backend/area/delete.php?id=" . $coluna['id'] ?>"
